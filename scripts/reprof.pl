...
#-------------------------------------------------- 
use lib qw(/mnt/project/reprof/perl/lib/);
...
reprof - predict secondary structure and solvent accessibility
